...
async function getProducts() {
  ...
  const resp = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_PATH}/api/products`, {next: {revalidate: 10}});
...
async function getDetails() {
  ...
  const dresp = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_PATH}/api/products/details`, {next: {revalidate: 1}});
