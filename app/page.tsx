...
async function getProducts() {
  ...
  const resp = await fetch(`https://ecommerce-iiser/api/products`, {next: {revalidate: 10}});
...
async function getDetails() {
  ...
  const dresp = await fetch(`https://ecommerce-iiser/api/products/details`, {next: {revalidate: 1}});
